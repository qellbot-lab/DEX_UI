    ...
    <div className="page team-page">
      <section className="team-compose chapter">
        <Reveal className="team-title">
          ...
          <p>三种策略风格共享一个风险预算。选择队长，决定最终决策如何被整合。</p>
        </Reveal>
        <Reveal className="team-status" delay={0.08}>
          <span>QELL TEST TEAM</span><div><b>{team.length}</b><small>/ 3 AGENTS</small></div>
        ...
        <Reveal className="team-thesis">
          ...
          <h2>{team.length >= 3 ? '宏观先识别周期，风险约束尾部，价值负责定价。' : '至少选择两个互补 Agent，才能生成战队论点。'}</h2>
